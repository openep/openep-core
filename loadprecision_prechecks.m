...
ind5 = regexp(firstLine,...
              ...
              'once');
ind6 = regexp(firstLine,...
              'Export\s*File\s*Version\s*:\s*10\.0R',...
              'once');
ind7 = regexp(firstLine,...
              'St\.\s*Jude Medical\.\s*File Revision\s*:\s*5\.6',...
              'once');
ind8 = regexp(firstLine,...
              'St\.\s*Jude Medical\.\s*File Revision\s*:\s*5\.7',...
              'once');

if isempty(ind1) && isempty(ind2) && isempty(ind3) && isempty(ind4) && isempty(ind5) && isempty(ind6) && isempty(ind7) && isempty(ind8)
