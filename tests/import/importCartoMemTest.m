classdef importCartoMemTest < matlab.unittest.TestCase
    ...
    methods (TestClassSetup)
        ...
        function loadCartoStudy1Map2(testCase)
            testingRoot = getenv("OPENEP_TESTING_DATA");
            studyFile = fullfile(testingRoot, ...
                'Carto/Export_Study-1-11_25_2021-15-01-32/Study 1 11_25_2021 15-01-32.xml');
            testCase.assumeTrue(strlength(testingRoot) > 0 && isfile(studyFile), ...
                'Set OPENEP_TESTING_DATA to run the legacy CARTO fixture tests.');
