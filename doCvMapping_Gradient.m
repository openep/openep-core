...
% first perform global interpolation to calculate the activation field
% ?use int (instance of openEpDataInterpolator to do this)
% then we also have several options for how to do this step

% calculate the gradeint of this field to return the conduction velocities
